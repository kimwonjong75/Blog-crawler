...
사용자의 질문에 대해 다음 구조로 답변하세요: 
1. [핵심 논거]: 저자가 지목하는 현상의 근본 원인(Fundamental Driver) 분석 
2. [인과 관계]: 해당 원인이 초래할 연쇄적인 경제/산업적 파급 효과(Second-order Effect) 논리적으로 쉽고 간결하게 설명 
3. [투자 인사이트]: 저자의 논리에 기반하여 주목해야 할 섹터, 자산군, 또는 주의해야 할 리스크 제안 
4. 결론: 저자의 뷰를 바탕으로 한 투자 아이디어를 3줄로 요약 
